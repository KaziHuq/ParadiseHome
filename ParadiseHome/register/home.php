  ...
  <body>
        ...
        <div class="navbar navbar-inverse" id="nav">
                <div class="container-fluid" id="navcont">
                        ...
                        <div class="col-lg-12">
                           ...
                           <div class="navbar-collapse collapse" id="mobile_menu">
                                ...
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <button type="button" class="btn btn-secondary"> <a href="profile.php">Profile</a> </button>
                                    <button type="button" class="btn btn-info"> <a href="register.php">Sign Up</a></button>
                    ...
                    <br>
                    <br>
                    <div class="jumbotron text-center" style="color: #c64756">
                    <h1>PARADISE HOME</h1>
                     <p>where you can find your own paradise</p>
                            ...
                            <form action="" class="navbar-form">
                                <div class="form-group">
                                  <div class="input-group" style="length:500px; width:1000px; padding: 45px; left:20%">
                                      <input type="search" name="search" id="" placeholder="Enter your Zip Code to get started..." class="form-control">
                              ...
                              <img src="assets/myhome.jpg" alt="myhome" style="length:500px; width:1470px">
                        </li>
                    </ul>
                </div>
